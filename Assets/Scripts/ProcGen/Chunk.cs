...
public class Chunk : MonoBehaviour
{
    ...
    [SerializeField] float coinSeprationLength = 2f;
    ...
    void SpawnCoins()
    {
        ...
        float topOfChunkZPos = transform.position.z + (coinSeprationLength * 2f);

        for(int i=0; i < coinsToSpawn; i++)
        {
            float spawnPositionZ = topOfChunkZPos - (i * coinSeprationLength);
    ...
    int SelectLane()
    {
        ...
        int laneIndex = availableLanes[randomLaneIndex];
